                        ...
                        <div class="refinery">
                            <div class="h1 searchTitle">
                                <p class="searchTitle">
                                    ...
                                    <router-link to="path:'competitionSquare">竞赛广场</router-link>
                                    >
                                    <router-link :to="{path:'competitionView',query:{id:id}}">竞赛申请</router-link>
                                    >
                                    参与竞赛
                                </p>
                            </div>
