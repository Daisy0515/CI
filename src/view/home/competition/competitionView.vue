        ...
        <div class="container">
            <el-card class="box-card0">
                <el-form :model="ruleForm" ref="ruleForm" class="demo-ruleForm">
                    ...
                    <el-form-item label="竞赛子类型：">
                        <span>{{typeValue}}</span>
                    </el-form-item>
                    <el-form-item label="一句话描述竞赛：">
                    ...
                    <!--     <el-form-item label="竞赛团队：" class="team">
                           <p v-if="ruleForm.headurlList.length===0">暂无竞赛团队</p>
                           <router-link
                    ...
                    <el-form-item class="publish">
                        <el-button type="primary" @click="submitForm('ruleForm')" size="medium">参与竞赛</el-button>
                    </el-form-item>
                </el-form>
            </el-card>
        </div>
