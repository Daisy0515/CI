        ...
        <el-row :gutter="40">
            <el-col :span="20">
                ...
                <el-card class="left-card-menu">
                    ...
                    <el-form :rules="rules" :model="ruleForm" label-position="left" label-width="120px"
                             style="margin-top: 2%;" ref="ruleForm"
                        ...
                        <el-input v-model="keywords" placeholder="用户名/手机号/邮箱"
                        ...
                        <div v-show="haveUser == true">
                            <el-table :data="searchData " :header-cell-style="rowClass" style="margin-top:10px;">
                                ...
                                <el-table-column label="操作">
                                    <template slot-scope="scope">
                                        <el-button @click="chooseUser(scope.row.id)" type="text" size="medium">设为评审专家
                                        </el-button>
                        ...
                        <div v-show="haveUser == false">
                            <h2 style="text-align: left;font-weight: bolder;margin-top: 2%;margin-bottom: 2%;">
                                注册新用户</h2>
                            ...
                            <el-form-item label="请输入密码" prop="password" :error="errorList.passError">
                                <el-input type="password" v-model="ruleForm.password" style="width:40%"
                                          autocomplete="off"></el-input>
                            </el-form-item>
                            <el-form-item label="请再次输入密码" prop="checkPass" :error="errorList.passError">
                                <el-input type="password" v-model="ruleForm.checkPass" style="width:40%"
                                          autocomplete="off"></el-input>
                            </el-form-item>
