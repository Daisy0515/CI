				...
				<div style="width: 75%; margin:0 auto;">
					<el-form :label-position="'left'" label-width="100px" :model="emailForm">
						<el-form-item label="收件人:">
							<el-checkbox-group v-model="userNameList" >
							    <el-checkbox v-for="item,index in emailList" :label="item.name" @change="handleCheckedUserChange($event,index)"></el-checkbox>
							</el-checkbox-group>
						...
						<el-form-item label="信件主体:">
							<el-input type="textarea" v-model="emailForm.emailConfig.content" rows="10" style="width: 90%;">
					...
					<el-dialog width="40%" title="邮件预览" :visible.sync="emailePrviewVisible" >
						...
						<div style="text-align: center;margin-top: 20px;">
							...
							<el-button type="primary" @click="send()" style="margin-left: 100px;" size="mini">发送</el-button>
						</div>
