<template>
    <div>
        ...
        <el-card>
            ...
            <div>
                <h3>给作者的意见:</h3>
                <el-input type="textarea" :rows="5" v-model="commentsToAuthor" :readonly="true"
                          :autosize="{minRows: 5, maxRows: 12 }"></el-input>
            </div>
            <br>
            <div>
                <h3>给管理员的意见:</h3>
                <el-input type="textarea" :rows="5" v-model="commentsToEditor" :readonly="true"
                          :autosize="{minRows: 5, maxRows: 12 }"></el-input>
            </div>
            <br>
            <!--管理员提交意见-->
            <el-form :model="localForm" ref="editorOpinionForm" :rules="editorOpinionFormRules"
                     v-if="intIdentification===1">
                    ...
                    <el-col :span="12">
                        <el-form-item>
                            <el-table :data="localForm.attachmentList" style="margin-top: 20px;" border>
                                <el-table-column property="attachmentName" label="附件名" align="center"
            ...
            <el-form :model="localForm" v-if="intIdentification===3">
                ...
                <el-form-item prop="details">
                    <h3><span style="color:red;">*</span>管理员的意见:</h3>
                    <el-input v-model="localForm.details" type="textarea" :rows="5" :readonly="true"
            ...
            <!--中止任务对话框-->
            <customize-email-dialog :visible="suspendVisible" :receiver="2" :templateId="templateId"
                                    :userList="suspendUserList" usedBy="editorOpinionAndDecision"
                                    :userListLoading="suspendUserListLoading" :templateList="templateList"
