...
<template>
    <el-dialog title="评审专家搜索" :visible.sync="dialogExpertVisible" :close-on-click-modal="false" width="80%"
        ...
        <invited-expert-list :infoList="invitedExpertList" :alter-list="alterList"
                             :invitedExpertVisible="invitedExpertVisible" :params="inviteExpertParams"
                             @closeDialog="closeInvitedExpertDialog"
