...
-->
<template>
    <el-dialog title="邀请评审专家" :visible.sync="invitedExpertVisible" :close-on-click-modal="false" width="50%"
               append-to-body :before-close="changeVisible">
        <el-dialog width="40%" title="邮件编辑" :visible.sync="emailEditVisible" append-to-body
                   :before-close="closeEmailEdit">
            <el-dialog width="40%" title="邮件预览" :visible.sync="emailePrviewVisible" append-to-body
                       :before-close="closeEmailPreview">
        ...
        <el-table :data="infoList" :header-cell-style="rowClass" style="margin-top: 20px;">
            ...
            <el-table-column label="信件" align="center" width="350px">
                <template slot-scope="scope">
                    ...
                    <el-button type="text" @click="emailEdit(scope.row,scope.$index)" style="margin-left: 10px">编辑
                    </el-button>
                </template>
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            finalInvite() {
                ...
                let postForm = {
                    expertInviteList: list,
                    id: parseInt(this.id),
                    alternativeList: this.params.alternativeList
                }
            ...
            preview() {
                ...
                let previewForm = {
                    adminMissionId: this.id,
                    userId: this.emailForm.userId,
                    emailContent: this.emailForm.config.content
                };
