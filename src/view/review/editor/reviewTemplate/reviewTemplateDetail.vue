    ...
    <div>
        ...
        <el-table :data="templateConfigList" style="margin-top: 20px;" border v-loading="configListLoading">
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    <el-button @click="handleReadItem(scope.$index)" type="text" size="medium"
                               v-if="isEmploy===true||isEmploy==='true'"
        ...
        <review-item-template
                ...
                :updateToBackEnd="updateToBackEnd"
        ...
        <review-template :templateConfigList="templateConfigList" :totalScore="totalScore"
                         :showSubmit="false"></review-template><!--生成评审表单的组件-->
    </div>
</template>
