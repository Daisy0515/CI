    ...
    <div class="myTable">
        ...
        <div class="search_header_top">
            ...
            <el-select v-model="searchData.researchId" clearable placeholder="研究方向">
                <el-option v-for="item in researchDirectionList" :label="item.researchDirection"
        ...
        <el-table :data="expertUserList" :header-cell-style="rowClass" style="margin-top: 20px;" v-loading="loading">
            ...
            <el-table-column label="操作" align="center" width="180px">
                <template slot-scope="scope">
                    <el-button @click="reviewInformaition(scope.row.uId)" type="text" size="medium"><i
                            class="icon iconfont icon-yonghu"></i>专家信息
                    </el-button>
                    <el-button @click="reviewStatistics(scope.row.uId)" type="text" size="medium"><i
                            class="el-icon-document"></i>评审统计
                    </el-button>
                </template>
            </el-table-column>

        </el-table>
        <review-statistics :tableData="tableData" :dialogFormVisible="statisticView"
                           @closeDialog="closeDialog"></review-statistics>
