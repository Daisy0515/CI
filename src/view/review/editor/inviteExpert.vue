<template>
    <div class="myTable">
        <div style="padding-left: 10px;">
                ...
                <el-form :label-position="'right'" label-width="350px" :model="ruleForm">
                    ...
                    <el-form-item label="评审打分模板">
                        <el-select v-model="ruleForm.templateId" clearable placeholder="请选择打分模板">
                            <el-option v-for="item in templateNameList" :label="item.templateName"
            ...
            <div>
                <el-table :data="expertInviteList" style="width:700px;margin:50px auto;" :header-cell-style="rowClass"
                          v-loading="loading">
                    ...
                    <el-table-column prop="gmtModified" label="状态更新时间" align="center">
                        <template slot-scope="scope">
                            <el-tooltip class="item" effect="dark" :content="scope.row.gmtModified"
                                        placement="top-start">
            ...
            <div>
                <el-table :data="expertAlternativeList" style="width:500px;margin:50px auto;"
