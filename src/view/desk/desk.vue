<template>
  <div class="desk clearfix">
    ...
    <keep-alive :include="getInclude">
      <router-view v-if="$route.meta.keepAlive" class="height_main" :imageUrl="getuserData&&getuserData.headurl"></router-view>
    </keep-alive>
    <router-view class="height_main" :imageUrl="getuserData&&getuserData.headurl" v-if="!$route.meta.keepAlive"></router-view>
