    ...
    <div class="teamSelect">
        ...
        <div class="container deskHeader">
            ...
            >
                ...
                <el-table-column prop="projectCognize" label="团队名称" align="center"></el-table-column>
        ...
        methods: {
            ...
            choice() {
                ...
                for (var i = 0; i < this.tableForm.length; i++) {
                    this.ReqBidTeamVO.idList.push(this.tableForm[i].id);
                }
                console.log(this.ReqBidTeamVO.idList);
                httpPut(
