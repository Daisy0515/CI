                        ...
                        <ul class="services">
                            <div class="serviceItem clearfix" v-for="(item, index) in notificationList " :key="index">
                                <div
                                    ...
                                    <el-button type="text" @click="showNoticeInfoDialog(item.id)"><i
                                            class="el-icon-search"></i>详情
                                    </el-button>
                                    <el-button type="text" @click="deleteNotice(item.id)"><i class="el-icon-delete"></i>删除
                                    </el-button>
                                </div>
                            </div>
                        </ul>
                        ...
                        <el-row :gutter="20">
                            <el-col :span="10">
                                <el-form-item label="相关人员" :label-width="formLabelWidth">
                                    <el-input v-model="noticeData.participantsList" auto-complete="off"
                                              :disabled="true"/>
                                </el-form-item>
                            </el-col>
                            <el-col :span="10">
                                ...
                                <el-form-item label="通知日期" :label-width="formLabelWidth">
                                    <el-input v-model="noticeData.notificationTime" auto-complete="off"
                                              :disabled="true"/>
                                </el-form-item>
                            </el-col>
                        </el-row>
