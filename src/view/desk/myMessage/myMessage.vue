        ...
        <el-table-column prop="content" label="消息内容" align="center" width="650px">
           <template slot-scope="scope">
             <span>{{scope.row.content}}
                ...
                <a style="cursor:pointer" v-if="scope.row.operationStatus===0&&scope.row.msgType===16" @click=consent(1,scope.row.teamId,scope.row)><i class="el-icon-circle-check"></i>同意</a>
                <a style="cursor:pointer" v-if="scope.row.operationStatus===0&&scope.row.msgType===16" @click=consent(2,scope.row.teamId,scope.row)><i class="el-icon-circle-close"></i>拒绝</a>
              
                <a style="cursor:pointer;color:gray;" v-if="scope.row.operationStatus===1&&scope.row.msgType===16" href="#"><i class="el-icon-circle-check"></i>同意</a>
                <a style="cursor:pointer;color:gray;" v-if="scope.row.operationStatus===1&&scope.row.msgType===16" href="#"><i class="el-icon-circle-close"></i>拒绝</a>
