...
<script>
    export default {
        ...
        created: function () {
            if (!this.$route.params.emailIndex) {
                this.$router.push({
                    path: "yzEmail"
                });
            } else {
                this.$set(this, "email", this.$route.params.newEmail);
            }
        },
        methods: {}
    };
