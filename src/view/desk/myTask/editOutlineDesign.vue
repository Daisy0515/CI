                ...
                <el-form :model="ruleForm" ref="ruleForm" class="demo-ruleForm">
                    <el-form-item class="cancel">
                        <div style="float: right;">
                            ...
                            <el-button type="primary" @click="" size="large" style="width:150px;display: inline;">下载模板
                            </el-button>
                        </div>
                    </el-form-item>
                    ...
                    <el-form-item label="备注" prop="remark">
                        <el-input type="textarea" class="input_textarea " v-model="ruleForm.remark" :rows="10"
                                  style="width:90%;float:right"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="原文件" prop="sourceFile">
                        ...
                        <div style="margin-left: 110px;">
                            <source-Upload :uploadIndex="uploadIndex" v-on:setIdCard="setIdCard($event)"/>
                        </div>
                    </el-form-item>

                    <el-form-item class="cancel">
                        <el-button type="primary" @click="returnDO" size="medium" style="width:150px;margin-left:25%">
                            返回
                        </el-button>
