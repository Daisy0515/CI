...
export default {
	...
	data() {
		...
		return {
			...
			// 表单验证
			rules: {
				introduction: [{ required: true, message: '请输入总体设计', trigger: 'blur' }],
				functionality: [{ required: true, message: '请输入接口设计', trigger: 'blur' }],
				design: [{ required: true, message: '请输入数据结构设计', trigger: 'blur' }]
			}
		};
	},
