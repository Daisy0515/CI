<template>
    <div class="myTask">
        ...
        <div class="header_top">
            ...
            <el-cascader placeholder="请选择项目类型" :options="getNormalType" change-on-select v-model="selectedOptions"
        ...
        <el-table v-loading="loading" :data="tableData" style="width:1200px;margin:0 auto"
            ...
            <el-table-column prop="accomplishProgress" label="操作" align="center" width="400">
                <template slot-scope="scope" class="operation">
                    <el-button type="primary" size="mini" class="btn" :data-clipboard-text="scope.row.httpUrlToRepo"
                               v-on:click="copyAddress()">复制git地址
                    </el-button>
                    <router-link
                            class="temClass"
                    ...
                    <router-link class="temClass" :to="{ path: 'needDesign', query: { id: scope.row.id } }"
                                 v-show="scope.row.missionTypeId === 1">
                        <i class="el-icon-edit"></i>
                        提交文档
                    </router-link>
                    <router-link class="temClass" :to="{ path: 'outlineDesign', query: { id: scope.row.id } }"
                                 v-show="scope.row.missionTypeId === 2">
                        <i class="el-icon-edit"></i>
                        提交文档
                    </router-link>
                    <router-link class="temClass" :to="{ path: 'detailedDesign', query: { id: scope.row.id } }"
                                 v-show="scope.row.missionTypeId === 3">
                        <i class="el-icon-edit"></i>
                        提交文档
                    </router-link>
                    <router-link class="temClass" v-show="scope.row.progress === 100"
                                 :to="{ path: 'resourceManagement', query: { id: scope.row.id } }">
                        <i class="el-icon-search"></i>
                        资源明细
                    </router-link>
                    <router-link to class="temClass" v-show="scope.row.progress != 100"
                                 @click.native="sliderChange(scope.row)">
