		...
		<div class="container deskHeader">
			<el-card class="box-card0">
				<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
					<el-form-item label="标题" prop="title"><el-input class="input_title title" v-model="ruleForm.title"></el-input></el-form-item>
              ...
              style="float:right;width:95%;height:350px;background: #ffffff;">
					...
					<el-form-item label="指派项目" prop="projectId">
						<el-select v-model="ruleForm.projectId" clearable placeholder="请选择项目" @change="getAppointList($event)">
							<el-option :value="item.projectId" v-for="(item, index) in projectSele" :key="index" :label="item.projectName"></el-option>
						</el-select>
					</el-form-item>
					<el-form-item label="指派人员" prop="appointId">
						<el-select id="appointuser" v-model="ruleForm.appointId" clearable placeholder="请选择人员" ref="ad">
							<el-option :value="item.userId" v-for="(item, index) in userSele" :key="index" :label="item.userName"></el-option>
						</el-select>
					</el-form-item>
