		...
		<div class="container deskHeader">
			<el-card class="box-card0">
				<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
					<el-form-item label="标题" prop="opinionTitle"><el-input class="input_title title" v-model="ruleForm.opinionTitle"></el-input></el-form-item>

					<el-form-item label="描述" prop="opinionDescription">
						<el-input type="textarea" class="input_textarea " v-model="ruleForm.opinionDescription" :rows="10" style="width:100%"></el-input>
              ...
              style="float:right;width:95%;height:350px;background: #ffffff;">
					...
					<el-form-item label="指派任务" prop="titleId">
						<el-select v-model="ruleForm.titleId" clearable placeholder="请选择任务名称" >
							<el-option v-for="item in missionTitle" :key="item.id" :label="item.title" :value="item.id"></el-option>
						</el-select>
					</el-form-item>
					<!-- 
					...
					<el-form-item class="publish">
						<el-button type="primary" @click="returnDO" size="medium" style="width:150px;">返回</el-button>
