<template>
	<div class="teamApplication">
		...
		<div style="float:left; margin-left: 350px;margin-top:50px ;">
			<div style="margin-left: 60%;">
		...
		<div style="margin-top:1000px; margin-bottom: 50px;margin-left: 850px;">
			<el-button type="primary" @click="$router.back(-1)" size="medium" style="width:150px;">返回</el-button>
		</div>
	</div>
</template>
