        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
            ...
            <el-form-item label="项目类型:">
                <el-radio-group v-model="parentIndex" size="medium" @change="changeType">
                    <el-radio-button :label="item.label" v-for="(item, index) in getNormalType"
                                     :key="index"></el-radio-button>
                </el-radio-group>
            </el-form-item>
            <el-form-item label="项目子类型:">
                <el-radio-group v-model="typeIndex" size="medium">
                    <el-radio-button :label="item.label" v-for="(item, index) in typeidData"
                                     :key="index"></el-radio-button>
                </el-radio-group>
            </el-form-item>
            ...
            <el-form-item label="项目交付资源">
                ...
                <el-dialog title="交付配置" width="40%" :visible.sync="dialogTableVisible">
                    ...
                    <el-button type="primary" @click="addItem" size="small" style="float: right;margin-top: 15px;">添加
                    </el-button>

                    <el-table :data="deliverData">
                        <el-table-column property="resourceName" label="资源名称" width="100"
                        ...
                        <el-table-column label="操作" width="80" align="center">
                            <template slot-scope="scope">
                                <router-link @click.native="deleteItem(scope.row.resourceName)" to><i
                                        class="el-icon-delete"></i></router-link>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-dialog>
            ...
            <div v-show="haveValue==='有'">
                <el-form-item label="评审流程">
                    ...
                    <el-dialog title="评审流程" width="40%" :visible.sync="dialogTableVisible1">
                        ...
                        <el-button type="primary" @click="addRItem" size="small" style="float: right;margin-top: 15px;">
                            添加
                        </el-button>

                        <el-table :data="reviewData">
                            <el-table-column property="processName" label="评审流程" width="100"
                                             align="center"></el-table-column>
                            <el-table-column property="demand" label="评审要求" align="center"></el-table-column>
                            <el-table-column label="操作" width="80" align="center">
                                <template slot-scope="scope">
                                    <router-link @click.native="deleteRItem(scope.row.processName)" to><i
                                            class="el-icon-delete"></i></router-link>
                                </template>
                            </el-table-column>
                        </el-table>
